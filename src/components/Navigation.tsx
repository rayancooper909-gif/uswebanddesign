...
import usaLogo from '@/assets/brand/WEB AND DESIGN 01.png';
...
export function Navigation() {
  ...
  return (
    ...
    >
      <nav className={`container-custom mx-auto flex items-center justify-between rounded-3xl px-4 sm:px-6 py-3 transition-[background-color,box-shadow,transform] duration-300 ease-out premium-panel ${isScrolled ? 'bg-background/95 shadow-xl' : 'bg-background/80'}`}>
        {/* Logo */}
